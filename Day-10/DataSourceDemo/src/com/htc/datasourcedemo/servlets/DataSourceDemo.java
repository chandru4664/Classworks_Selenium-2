package com.htc.datasourcedemo.servlets;
...
public class DataSourceDemo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			// Connection object by ConnectionPoolDatasource
			ConnectionPoolDataSource cpds=(ConnectionPoolDataSource) ctx.lookup("java:/comp/env/jdbc/pgsql");
			
			PooledConnection pc=cpds.getPooledConnection();
			con=pc.getConnection();
			
			
			/*  // Connection object by DataSource
